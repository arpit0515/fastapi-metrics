...
---
Generated by FastAPI Metrics v0.3.13
"""
...
def main():
    ...
    print(
        f"""
Files created:
  {f'✓ {code_file} - Your metrics setup code' if code_file else ''}
  {f'✓ {doc_file} - Customized documentation' if doc_file else ''}
